...
# recommender_kedro documentation build
...
from recommender_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "recommender_kedro"
author = "Kedro"
...
htmlhelp_basename = "recommender_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "recommender_kedro.tex",
        "recommender_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "recommender_kedro",
        "Project recommender_kedro codebase.",
        "Data-Science",
    )
]
